...
\subsubsection{Use case: Authenticate}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth, height=0.3\textheight]{image/AuthenticationUseCase.png} 
...
\subsubsection{Use case: Student Schedule}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.75\textwidth, height=0.3\textheight]{image/StudentScheduleUseCase.png} 
