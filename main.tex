...
\textbf{Use case: Student Schedule} \\
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|m{3.5cm}|p{10cm}|} 
            \hline
            \multicolumn{1}{|c|}{\textbf{Actor Action}} & \multicolumn{1}{c|}{\textbf{System Action}} \\ \hline
            \multirow{3.5}{=}{\centering \shortstack[c]{User click button \\ "Timetable"}} 
            ...
            \multirow{4.9}{=}{\centering \shortstack[c]{User click button \\ "Favorite Course"}} 
            ...
            \multirow{5.4}{=}{\centering \shortstack[c]{User click button \\ "Course"}} 
...
\textbf{Use case: University Campus} \\
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|m{3.5cm}|p{10cm}|} 
            \hline
            \multicolumn{1}{|c|}{\textbf{Actor Action}} & \multicolumn{1}{c|}{\textbf{System Action}} \\ \hline
            \multirow{2.8}{=}{\centering \shortstack[c]{User click button \\ "Building"}} 
            ...
            \multirow{1.5}{=}{\centering \shortstack[c]{User click button \\ "Map"}} 
...
\textbf{Use case: University Resource} \\
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|m{3.5cm}|p{10cm}|} 
            \hline
            \multicolumn{1}{|c|}{\textbf{Actor Action}} & \multicolumn{1}{c|}{\textbf{System Action}} \\ \hline
            \multirow{2.8}{=}{\centering \shortstack[c]{User click button \\ "Show Resource"}} 
...
\textbf{Use case: Student StudyBuddy} \\
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|m{3.5cm}|p{10cm}|} 
            \hline
            \multicolumn{1}{|c|}{\textbf{Actor Action}} & \multicolumn{1}{c|}{\textbf{System Action}} \\ \hline
            \multirow{6.3}{=}{\centering \shortstack[c]{User click button \\ "StudyBuddy"}} 
            ...
            \multirow{3.4}{=}{\centering \shortstack[c]{User click button \\ "Message"}} 
            ...
            \multirow{3.4}{=}{\centering \shortstack[c]{User click button \\ "Contact"}} 
            & 1. The system displays students who Students have matched with \\ \cline{2-2}
            & 2. After clicking the contact, start an audio call with another student \\ \hline
            \multirow{3.9}{=}{\centering \shortstack[c]{User click button \\ "Profile"}} 
...
\textbf{Use case: Real Time Notification} \\
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|m{3.5cm}|p{10cm}|} 
            \hline
            \multicolumn{1}{|c|}{\textbf{Actor Action}} & \multicolumn{1}{c|}{\textbf{System Action}} \\ \hline
            \multirow{2.7}{=}{\centering \shortstack[c]{Admin update or \\ add event to \\ the user’s calendar}} 
            & 1. The system detects the calendar changes and triggers the notification \\
            & \\ \hline 
            \multirow{1.8}{=}{\centering \shortstack[c]{User receives \\ an incoming call}} 
            & 1. The system identifies incoming calls and sends a push notification to inform users in real time \\ \hline
            \multirow{4.8}{=}{\centering \shortstack[c]{User click on \\ the notification}} 
